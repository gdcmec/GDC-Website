    ...
    <>
        <footer>
            ...
            <div className="rights">
                <h3 className="rightsh3">
                <span>© 2024 GDC MEC All rights reserved. </span> Terms and Conditions | Privacy Policy
                </h3>
            </div>
        </footer>
    </>
